...
def train_imdb_model():
    ...
    # Get word index and decode an example review
    ...
    print("Label of the first review (1=Positive, 0=Negative):", train_labels[0])
    ...
    print("\nModel results on test set (Loss, Accuracy):", results)
